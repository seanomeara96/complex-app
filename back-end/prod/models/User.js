        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, db_1.fetchCollection("users").findOne({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, db_1.fetchCollection("users").insertOne(this.data)];
                case 2:
                    // Adds the new user to the database
                    _a.sent();
                    this.getAvatar();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db_1.fetchCollection("users").findOne({ email: email })];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            resolve(true);
